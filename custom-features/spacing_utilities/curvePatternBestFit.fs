 ...
 * }}
 */
annotation { "Feature Type Name" : "Curve pattern (Best fit)", "Filter Selector" : "allparts", "Manipulator Change Function" : "curvePatternPointChange",
        "Feature Type Description" : "Create a pattern along a curve.<br>" ~
        "This feature adds a spacing type of Best fit.<br>" ~
        "This will automatically determine the correct number of instances for a curve pattern with a specified target pitch." }
export const curvePatternBestFit = defineFeature(function(context is Context, id is Id, definition is map)
    precondition
    {
